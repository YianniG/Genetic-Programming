...
functionDomain = {"+": GenerateFunctionDomain([-5, 5], [], False), "*": GenerateFunctionDomain([-5, 5], [], False),
                  "/": GenerateFunctionDomain([-5, 5], [0], False), "^": GenerateFunctionDomain([0, 5], [], False),
                  "!": GenerateFunctionDomain([0, 5], [], True)};
aim = 25;
maxPrograms = 1000;
